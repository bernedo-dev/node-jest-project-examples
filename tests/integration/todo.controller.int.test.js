...
const nonExistingTodoId = '6135316a60e41f4dd9bbbaf6';
...
describe(endpointUrl, () => {
    ...
    test("Get todo by id doesnt't exist "+endpointUrl+":todoId", async()=>{
    ...
    test('HTTP DELETE 404', async()=>{
        const res = await (await request(app).delete(endpointUrl+nonExistingTodoId)).setEncoding();
        expect(res.statusCode).toBe(404);
    });
});